...
class Tabla:
            ...
            for column in range(8):
                if (row + column) % 2 == 0:
                    ...
                    if (fig.color == RED or fig.color == WHITE):
                        fig.drawcircle(screen)
                    if (row, column, False) in self.validMoves or (row, column, True) in self.validMoves:
                        fig2 = Figura(row, column, BLUE)
                        fig2.drawcircle(screen)
    ...
    def nomoves(self):
        ...
        for row in range(8):
            for column in range(8):
                if self.turn == self.board[row][column].color:
    ...
    def getValidMoves(self, row, column):
        ...
        if color == RED or piece.king:
            if (row - 1) >= 0 and (column - 1) >= 0:
                ...
                if (color == RED and piece1.color == WHITE and (row - 2) >= 0 and (column - 2) >= 0) or (
                        color == WHITE and piece1.color == RED and (row - 2) >= 0 and (column - 2) >= 0):
            ...
            if (row - 1) >= 0 and (column + 1) < 8:
                ...
                if piece2.color == GREEN and (row - 1) >= 0 and (column + 1) < 8:
                    self.validMoves.append((row - 1, column + 1, False))
                if (color == RED and piece2.color == WHITE and (row - 2) >= 0 and (column + 2) < 8) or (
                        color == WHITE and piece2.color == RED and (row - 2) >= 0 and (column + 2) < 8):
                    piece11 = self.board[row - 2][column + 2]
                    if piece11.color == GREEN:
                        self.validMoves.append((row - 2, column + 2, True))
        if color == WHITE or piece.king:
            if (row + 1) < 8 and (column - 1) >= 0:
                ...
                if piece1.color == GREEN:
                    self.validMoves.append((row + 1, column - 1, False))
                if (color == WHITE and piece1.color == RED and (row + 2) < 8 and (column - 2) >= 0) or (
                        color == RED and piece1.color == WHITE and (row + 2) < 8 and (column - 2) >= 0):
                    piece11 = self.board[row + 2][column - 2]
                    if piece11.color == GREEN:
                        self.validMoves.append((row + 2, column - 2, True))
            ...
            if (row + 1) < 8 and (column + 1) < 8:
                ...
                if piece2.color == GREEN and (row + 1) < 8 and (column + 1) < 8:
                    self.validMoves.append((row + 1, column + 1, False))
                if (color == WHITE and piece2.color == RED and (row + 2) < 8 and (column + 2) < 8) or (
                        color == RED and piece2.color == WHITE and (row + 2) < 8 and (column + 2) < 8):
                    piece11 = self.board[row + 2][column + 2]
                    if piece11.color == GREEN:
                        self.validMoves.append((row + 2, column + 2, True))
